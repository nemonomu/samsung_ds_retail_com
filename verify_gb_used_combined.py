"""
Crawl ONLY GB combined-label / used-buy canary ASINs using the production
AmazonUKScraper, skip DB save and file-server upload. Result printed to
console only.

Tests whether legacy used-layout XPath unwrap fix restored GB extraction.
"""
import os
import sys
...
from uk_v2 import AmazonUKScraper


TEST_ASINS = [
    ('B003J5JB12', 'used_separate',    'Amazon'),
    ('B0B9C4DKKG', 'regular_combined', 'Texeno'),
    ('B0BM459NHM', 'regular_combined', 'Texeno'),
]
...
def main():
    ...
    print()
    print('=' * 100)
    print('GB canary extraction result (NOT saved to DB):')
    print('=' * 100)
